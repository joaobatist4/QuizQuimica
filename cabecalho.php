<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/knowqui.css">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #00FF7F" >
          ...
          <a class="navbar-brand" href="#">KnowQui</a>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="../cadastros/cadastro-aluno.php">Alunos</a>
                  <a class="dropdown-item" href="../cadastros/cadastro-perguntas.php">Perguntas e Respostas</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="../cadastros/cadastro-tipo-perguntas.php">Tipo de Perguntas</a>
                </div>
