...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #E0FFFF" >
          ...
          <a class="navbar-brand" href="{{action('HomeController@index')}}">KnowQui</a>
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="{{action('PerguntaController@lista')}}">Perguntas e Respostas</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="{{action('TipoPerguntaController@lista')}}">Tipo de Perguntas</a>
                </div>
